...
from bars import ext_widgets, init_widgets
...
screens = [
    Screen(
        ...
        wallpaper_mode="fill",
        top=bar.Bar(init_widgets(), 28, background=transparent, margin=[0, 8, 0, 8]),
    ),
    Screen(
        wallpaper="/mnt/sda1/Library/OS/customs/UnixImgs/tux.jpg",
        wallpaper_mode="fill",
        top=bar.Bar(ext_widgets(), 28, background=transparent, margin=[0, 8, 0, 8]),
    ),
]
